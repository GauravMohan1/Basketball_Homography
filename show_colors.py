...
ap.add_argument("-p", "--path", required=True, help="/Users/gauravmohan/Documents/PycharmProjects/basketball/basketballVideoAnalysis-master/mini-map-tutorial/images")
